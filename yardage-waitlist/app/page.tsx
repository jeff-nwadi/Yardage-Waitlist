    ...
    <div className="bg-[#fcf8e6] h-screen">
      ...
      <div className="flex flex-col items-center justify-center relative py-24">
        <div className="absolute inset-0 w-full h-full max-w-7xl mx-auto pointer-events-none">
          {/* Top Left - Shoe Racks */}
          <Image src={icon2} alt="Shoe Racks" width={145} height={57} className="absolute w-20 h-20 md:w-28 md:h-28 lg:w-36 lg:h-36 left-[15%] top-[5%] md:left-[12%] md:top-[6%] lg:left-[20%] lg:top-[-2%]" />

          {/* Top Right - Chairs */}
          <Image src={icon3} alt="Chairs" width={145} height={57} className="absolute w-20 h-20 md:w-28 md:h-28 lg:w-36 lg:h-36 right-[15%] top-[10%] md:right-[12%] md:top-[6%] lg:right-[17%] lg:top-[-2%]" />

          {/* Bottom Left - Cupboards */}
          <Image src={icon1} alt="Cupboards" width={145} height={57} className="absolute w-20 h-20 md:w-28 md:h-28 lg:w-36 lg:h-36 left-[15%] -bottom-[10%] md:left-[10%] md:bottom-[15%] lg:left-[10%] lg:bottom-[30%]" />

          {/* Bottom Right - Gadgets */}
          <Image src={icon4} alt="Gadgets" width={145} height={57} className="absolute w-20 h-20 md:w-28 md:h-28 lg:w-36 lg:h-36 right-[15%] -bottom-[6%] md:right-[10%] md:bottom-[15%] lg:right-[8%] lg:bottom-[35%]" />
        </div>
